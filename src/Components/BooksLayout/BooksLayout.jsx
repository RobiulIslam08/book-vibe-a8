    ...
    return (
        <div>
            ...
            <div className="card-body">
               ...
               <h1 className="text-[#131313] font-bold text-2xl">{bookName.slice(0,20)}</h1>
